const generateHTML = (pageName) => {
  ...
  <div class="text">
    ...
    <button id='_btn' style =' display: inline-block; padding: 15px 25px; font-size: 24px; cursor: pointer; text-align: center;text-decoration: none; outline: none;
    color: #fff; background-color: #4CAF50; border: none; border-radius: 15px; box-shadow: 0 9px #999;'>Click me to waste time</button>
  </div>
  ...
  var links= ["https://codeforces.com/",
  ...
  const generateSTYLING = () => {
    ...
    ._btn:hover {background-color: #3e8e41}
  ...
  switch (window.location.hostname){
    case "www.youtube.com":
        ...
        document.getElementById('_btn').onclick = WasteTime;
        break;
